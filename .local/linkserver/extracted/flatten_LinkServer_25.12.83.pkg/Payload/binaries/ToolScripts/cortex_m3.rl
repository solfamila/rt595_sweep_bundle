...
# Built-in register support for a Cortex M3
...
# Definition of registers in a TPIU peripheral on a Coretex M3
# Each entry has
...
set dev.TPIU[rd,wr]:{[
    ...
    ITATBCTR2  = <0xEF0,rd,rd,NULL>, # set ETM/ITM ATREADY outputs
    FIFO1      = <0xEFC,rd,rd,NULL>,
    ITATBCTR0  = <0xEF8,rd,rd,NULL>, # read ATVALIDS1 | ATVALIDS2
...
# Definition of registers in an ETM peripheral on a Coretex M3
...
# Definition of registers in an ITM peripheral on a Coretex M3
set dev.ITM[rd,wr]:{[
